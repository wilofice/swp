...
<body>
    <script type="text/javascript">
        ...
        function redirectToAdd(){
            window.location.href = "http://localhost:8080/swp/addUtilisateur";
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <input type="text" name="ensid" style="display: none;" value="<c:out value="${ensSelected.id}"/>" required/>
      <div class="form-group">
        <label for="nomU">Nom *</label>
        <input type="text" class="form-control" id="nomU" name="nomU" aria-describedby="emailHelp" placeholder="Entrer le nom de l'utilisateur" value="<c:out value="${ensSelected.getNom()}"/>" required>
        </div>
      <div class="form-group">
        <label for="prenomU">Prénom *</label>
        <input type="text" class="form-control" id="prenomU" name="prenomU" placeholder="Entrer le Prénom de l'utilisateur" value="<c:out value="${ensSelected.getPrenom()}"/>" required>
      </div>
      <div class="form-group row">
         
          <div class="col-xs-7"> 
             <label> Mail *</label>
            <input type="text" class="form-control" id="P1Mail" name="P1Mail" placeholder="Entrer l'adresse mail de l'utilisateur" value="<c:out value="${ensSelected.email.split('@')[0]}"/>" required>
          </div>
          <div class="col-xs-5"> 
              <label> <br/> </label>
      ...
      <div class="form-group">
        ...
        <input type="tel" class="form-control" onblur="verifTel(this)" id="telU" name="telU" placeholder="Entrer le numéro de  téléphone de l'utilisateur" value="<c:out value="${ensSelected.getTel()}"/>" required>
      </div>
       <div class="form-group">
